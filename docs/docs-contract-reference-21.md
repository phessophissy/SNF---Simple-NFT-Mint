# docs-contract-reference - Section 21

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 21 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 21.0 | Initial documentation | Part 21 |

---
*Part 21 of 50 in the docs-contract-reference series*
