# docs-contract-reference - Section 37

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 37 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 37.0 | Initial documentation | Part 37 |

---
*Part 37 of 50 in the docs-contract-reference series*
