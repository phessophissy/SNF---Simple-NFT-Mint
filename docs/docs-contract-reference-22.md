# docs-contract-reference - Section 22

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 22 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 22.0 | Initial documentation | Part 22 |

---
*Part 22 of 50 in the docs-contract-reference series*
