# docs-contract-reference - Section 24

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 24 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 24.0 | Initial documentation | Part 24 |

---
*Part 24 of 50 in the docs-contract-reference series*
