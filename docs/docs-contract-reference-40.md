# docs-contract-reference - Section 40

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 40 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 40.0 | Initial documentation | Part 40 |

---
*Part 40 of 50 in the docs-contract-reference series*
