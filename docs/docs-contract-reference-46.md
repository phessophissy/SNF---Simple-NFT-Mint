# docs-contract-reference - Section 46

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 46 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 46.0 | Initial documentation | Part 46 |

---
*Part 46 of 50 in the docs-contract-reference series*
