# docs-contract-reference - Section 7

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 7 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 7.0 | Initial documentation | Part 7 |

---
*Part 7 of 20 in the docs-contract-reference series*
