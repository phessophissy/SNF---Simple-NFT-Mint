# docs-contract-reference - Section 34

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 34 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 34.0 | Initial documentation | Part 34 |

---
*Part 34 of 50 in the docs-contract-reference series*
