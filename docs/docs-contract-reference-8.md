# docs-contract-reference - Section 8

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 8 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 8.0 | Initial documentation | Part 8 |

---
*Part 8 of 20 in the docs-contract-reference series*
