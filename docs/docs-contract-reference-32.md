# docs-contract-reference - Section 32

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 32 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 32.0 | Initial documentation | Part 32 |

---
*Part 32 of 50 in the docs-contract-reference series*
