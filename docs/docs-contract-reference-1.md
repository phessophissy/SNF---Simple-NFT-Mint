# docs-contract-reference - Section 1

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 1 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 1.0 | Initial documentation | Part 1 |

---
*Part 1 of 20 in the docs-contract-reference series*
