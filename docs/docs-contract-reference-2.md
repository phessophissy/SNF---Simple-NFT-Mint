# docs-contract-reference - Section 2

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 2 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 2.0 | Initial documentation | Part 2 |

---
*Part 2 of 20 in the docs-contract-reference series*
