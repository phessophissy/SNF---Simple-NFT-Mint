# docs-contract-reference - Section 45

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 45 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 45.0 | Initial documentation | Part 45 |

---
*Part 45 of 50 in the docs-contract-reference series*
