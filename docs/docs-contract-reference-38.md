# docs-contract-reference - Section 38

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 38 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 38.0 | Initial documentation | Part 38 |

---
*Part 38 of 50 in the docs-contract-reference series*
