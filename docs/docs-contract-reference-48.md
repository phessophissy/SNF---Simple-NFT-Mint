# docs-contract-reference - Section 48

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 48 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 48.0 | Initial documentation | Part 48 |

---
*Part 48 of 50 in the docs-contract-reference series*
