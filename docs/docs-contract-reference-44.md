# docs-contract-reference - Section 44

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 44 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 44.0 | Initial documentation | Part 44 |

---
*Part 44 of 50 in the docs-contract-reference series*
