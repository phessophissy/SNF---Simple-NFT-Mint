# docs-contract-reference - Section 41

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 41 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 41.0 | Initial documentation | Part 41 |

---
*Part 41 of 50 in the docs-contract-reference series*
