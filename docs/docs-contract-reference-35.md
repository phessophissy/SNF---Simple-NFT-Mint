# docs-contract-reference - Section 35

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 35 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 35.0 | Initial documentation | Part 35 |

---
*Part 35 of 50 in the docs-contract-reference series*
