# docs-contract-reference - Section 42

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 42 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 42.0 | Initial documentation | Part 42 |

---
*Part 42 of 50 in the docs-contract-reference series*
