# docs-contract-reference - Section 13

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 13 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 13.0 | Initial documentation | Part 13 |

---
*Part 13 of 20 in the docs-contract-reference series*
