# docs-contract-reference - Section 19

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 19 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 19.0 | Initial documentation | Part 19 |

---
*Part 19 of 20 in the docs-contract-reference series*
