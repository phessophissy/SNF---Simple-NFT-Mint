# docs-contract-reference - Section 9

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 9 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 9.0 | Initial documentation | Part 9 |

---
*Part 9 of 20 in the docs-contract-reference series*
