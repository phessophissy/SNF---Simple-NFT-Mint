# docs-contract-reference - Section 39

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 39 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 39.0 | Initial documentation | Part 39 |

---
*Part 39 of 50 in the docs-contract-reference series*
