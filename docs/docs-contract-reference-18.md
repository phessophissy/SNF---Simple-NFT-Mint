# docs-contract-reference - Section 18

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 18 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 18.0 | Initial documentation | Part 18 |

---
*Part 18 of 20 in the docs-contract-reference series*
