# docs-contract-reference - Section 33

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 33 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 33.0 | Initial documentation | Part 33 |

---
*Part 33 of 50 in the docs-contract-reference series*
