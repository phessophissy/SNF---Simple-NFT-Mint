# docs-contract-reference - Section 20

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 20 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 20.0 | Initial documentation | Part 20 |

---
*Part 20 of 20 in the docs-contract-reference series*
