# docs-contract-reference - Section 47

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 47 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 47.0 | Initial documentation | Part 47 |

---
*Part 47 of 50 in the docs-contract-reference series*
