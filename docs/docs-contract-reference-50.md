# docs-contract-reference - Section 50

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 50 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 50.0 | Initial documentation | Part 50 |

---
*Part 50 of 50 in the docs-contract-reference series*
