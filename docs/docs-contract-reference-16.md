# docs-contract-reference - Section 16

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 16 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 16.0 | Initial documentation | Part 16 |

---
*Part 16 of 20 in the docs-contract-reference series*
