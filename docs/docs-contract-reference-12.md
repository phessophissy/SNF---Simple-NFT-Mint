# docs-contract-reference - Section 12

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 12 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 12.0 | Initial documentation | Part 12 |

---
*Part 12 of 20 in the docs-contract-reference series*
