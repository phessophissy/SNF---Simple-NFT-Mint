# docs-contract-reference - Section 14

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 14 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 14.0 | Initial documentation | Part 14 |

---
*Part 14 of 20 in the docs-contract-reference series*
