# docs-contract-reference - Section 36

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 36 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 36.0 | Initial documentation | Part 36 |

---
*Part 36 of 50 in the docs-contract-reference series*
