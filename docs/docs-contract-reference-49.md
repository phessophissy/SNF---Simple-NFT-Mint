# docs-contract-reference - Section 49

> Documentation for SNF - Simple NFT Mint

## Overview

This section covers part 49 of the docs-contract-reference documentation series for the Simple NFT Mint Studio project.
...
|---------|--------|---------|
| 49.0 | Initial documentation | Part 49 |

---
*Part 49 of 50 in the docs-contract-reference series*
